    ...
    <aside className="studio-inspector-panel unity-spot-inspector">
      <div className="unity-studio-panel-titlebar">
        ...
        <span className="meta-pill" lang="en">
          {isSpotStudio ? "SPOT" : effectiveSpot ? "SPOT" : "DECK"}
        </span>
      </div>
      ...
      <div className="unity-spot-inspector-body">
        <div className="unity-inspector-object-header">
          ...
          <h2>{isSpotStudio ? effectiveSpot?.name ?? "Spot 선택" : effectiveSpot?.name ?? deckDraft.name}</h2>
        </div>
        ...
        {effectiveSpot ? (
          ...
          <>
            <InspectorSection title="Deck">
              <div className="detail-grid">
                <DetailItem label="Domain" value={deckDraft.domainName} />
                <DetailItem label="Deck" value={`${deckDraft.label} ${deckDraft.name}`} />
