...
export function AreaSelectionPanel({
  canEdit = true,
  selectedArea,
  handleRenameArea,
  handleUpdateArea
...
export function WaypointSelectionPanel({
  canEdit = true,
  selectedWaypoint,
    ...
    <div className="map-selection-overlay">
      ...
      <label className="map-selection-color-row">
        ...
        <input
          className="inspector-input is-color"
          type="color"
          value={selectedWaypoint.color ?? waypointColorById.get(selectedWaypoint.id) ?? SPOT_STUDIO_WAYPOINT_COLOR}
...
export function SpotSelectionPanel({ effectiveSpot }) {
  return (
    <div className="map-selection-overlay">
      <p className="map-selection-overlay-type" lang="en">
        SPOT
